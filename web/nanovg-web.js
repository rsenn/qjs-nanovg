async function Module(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if(Module['locateFile']) {
      return locateFile('nanovg-web.wasm');
    }
    return new URL('nanovg-web.wasm', import.meta.url).href;
  }
    ...
    createNode(parent, name, mode, dev) {
      ...
      MEMFS.ops_table ||= {
        ...
        file: {
          ...
          stream: { llseek: MEMFS.stream_ops.llseek, read: MEMFS.stream_ops.read, write: MEMFS.stream_ops.write, mmap: MEMFS.stream_ops.mmap, msync: MEMFS.stream_ops.msync },
        },
  ...
  var _free,
    _nvgw_Create,
    _nvgw_Delete,
    _nvgw_CreateImageFromHandle,
    _nvgw_ImageHandle,
    _nvgw_CreateFramebuffer,
    _nvgw_BindFramebuffer,
    _nvgw_DeleteFramebuffer,
    _nvgw_FramebufferField,
    _nvgw_ReadPixels,
    _nvgw_BeginFrame,
    _nvgw_CancelFrame,
    _nvgw_EndFrame,
    ...
    _nvgw_Restore,
    _nvgw_Reset,
    _nvgw_ShapeAntiAlias,
    _nvgw_Scissor,
    _nvgw_IntersectScissor,
    _nvgw_ResetScissor,
    _nvgw_MiterLimit,
    _nvgw_LineCap,
    _nvgw_LineJoin,
    ...
    _nvgw_PaintPtr,
    _nvgw_PaintSize,
    _nvgw_LinearGradient,
    _nvgw_BoxGradient,
    _nvgw_RadialGradient,
    _nvgw_ImagePattern,
    _nvgw_ResetTransform,
    _nvgw_Transform,
    _nvgw_Translate,
    _nvgw_Rotate,
    _nvgw_SkewX,
    ...
    _nvgw_Rect,
    _nvgw_RoundedRect,
    _nvgw_RoundedRectVarying,
    _nvgw_Circle,
    _nvgw_Ellipse,
    _nvgw_Fill,
    _nvgw_Stroke,
    _nvgw_CreateFont,
    _nvgw_CreateFontAtIndex,
    _nvgw_FindFont,
    _nvgw_FontFace,
    _nvgw_FontSize,
    _nvgw_FontBlur,
    _nvgw_TextLetterSpacing,
    _nvgw_TextLineHeight,
    _nvgw_TextAlign,
    _nvgw_Text,
    _nvgw_TextBox,
    _nvgw_TextBounds,
    _nvgw_TextBoxBounds,
    _nvgw_CreateImage,
    _nvgw_CreateImageMem,
    _nvgw_CreateImageRGBA,
    _nvgw_UpdateImage,
    _nvgw_ImageWidth,
    _nvgw_ImageHeight,
    _nvgw_DeleteImage,
  ...
  function assignWasmExports(wasmExports) {
    ...
    _nvgw_Create = Module['_nvgw_Create'] = wasmExports['nvgw_Create'];
    _nvgw_Delete = Module['_nvgw_Delete'] = wasmExports['nvgw_Delete'];
    _nvgw_CreateImageFromHandle = Module['_nvgw_CreateImageFromHandle'] = wasmExports['nvgw_CreateImageFromHandle'];
    _nvgw_ImageHandle = Module['_nvgw_ImageHandle'] = wasmExports['nvgw_ImageHandle'];
    _nvgw_CreateFramebuffer = Module['_nvgw_CreateFramebuffer'] = wasmExports['nvgw_CreateFramebuffer'];
    _nvgw_BindFramebuffer = Module['_nvgw_BindFramebuffer'] = wasmExports['nvgw_BindFramebuffer'];
    _nvgw_DeleteFramebuffer = Module['_nvgw_DeleteFramebuffer'] = wasmExports['nvgw_DeleteFramebuffer'];
    _nvgw_FramebufferField = Module['_nvgw_FramebufferField'] = wasmExports['nvgw_FramebufferField'];
    _nvgw_ReadPixels = Module['_nvgw_ReadPixels'] = wasmExports['nvgw_ReadPixels'];
    _nvgw_BeginFrame = Module['_nvgw_BeginFrame'] = wasmExports['nvgw_BeginFrame'];
    _nvgw_CancelFrame = Module['_nvgw_CancelFrame'] = wasmExports['nvgw_CancelFrame'];
    _nvgw_EndFrame = Module['_nvgw_EndFrame'] = wasmExports['nvgw_EndFrame'];
    _nvgw_Save = Module['_nvgw_Save'] = wasmExports['nvgw_Save'];
    _nvgw_Restore = Module['_nvgw_Restore'] = wasmExports['nvgw_Restore'];
    _nvgw_Reset = Module['_nvgw_Reset'] = wasmExports['nvgw_Reset'];
    _nvgw_ShapeAntiAlias = Module['_nvgw_ShapeAntiAlias'] = wasmExports['nvgw_ShapeAntiAlias'];
    _nvgw_Scissor = Module['_nvgw_Scissor'] = wasmExports['nvgw_Scissor'];
    _nvgw_IntersectScissor = Module['_nvgw_IntersectScissor'] = wasmExports['nvgw_IntersectScissor'];
    _nvgw_ResetScissor = Module['_nvgw_ResetScissor'] = wasmExports['nvgw_ResetScissor'];
    _nvgw_MiterLimit = Module['_nvgw_MiterLimit'] = wasmExports['nvgw_MiterLimit'];
    _nvgw_LineCap = Module['_nvgw_LineCap'] = wasmExports['nvgw_LineCap'];
    _nvgw_LineJoin = Module['_nvgw_LineJoin'] = wasmExports['nvgw_LineJoin'];
    _nvgw_GlobalAlpha = Module['_nvgw_GlobalAlpha'] = wasmExports['nvgw_GlobalAlpha'];
    _nvgw_StrokeWidth = Module['_nvgw_StrokeWidth'] = wasmExports['nvgw_StrokeWidth'];
    _nvgw_StrokeColor = Module['_nvgw_StrokeColor'] = wasmExports['nvgw_StrokeColor'];
    _nvgw_FillColor = Module['_nvgw_FillColor'] = wasmExports['nvgw_FillColor'];
    _nvgw_StrokePaint = Module['_nvgw_StrokePaint'] = wasmExports['nvgw_StrokePaint'];
    _nvgw_FillPaint = Module['_nvgw_FillPaint'] = wasmExports['nvgw_FillPaint'];
    _nvgw_PaintPtr = Module['_nvgw_PaintPtr'] = wasmExports['nvgw_PaintPtr'];
    _nvgw_PaintSize = Module['_nvgw_PaintSize'] = wasmExports['nvgw_PaintSize'];
    _nvgw_LinearGradient = Module['_nvgw_LinearGradient'] = wasmExports['nvgw_LinearGradient'];
    _nvgw_BoxGradient = Module['_nvgw_BoxGradient'] = wasmExports['nvgw_BoxGradient'];
    _nvgw_RadialGradient = Module['_nvgw_RadialGradient'] = wasmExports['nvgw_RadialGradient'];
    _nvgw_ImagePattern = Module['_nvgw_ImagePattern'] = wasmExports['nvgw_ImagePattern'];
    _nvgw_ResetTransform = Module['_nvgw_ResetTransform'] = wasmExports['nvgw_ResetTransform'];
    _nvgw_Transform = Module['_nvgw_Transform'] = wasmExports['nvgw_Transform'];
    _nvgw_Translate = Module['_nvgw_Translate'] = wasmExports['nvgw_Translate'];
    _nvgw_Rotate = Module['_nvgw_Rotate'] = wasmExports['nvgw_Rotate'];
    _nvgw_SkewX = Module['_nvgw_SkewX'] = wasmExports['nvgw_SkewX'];
    _nvgw_SkewY = Module['_nvgw_SkewY'] = wasmExports['nvgw_SkewY'];
    _nvgw_Scale = Module['_nvgw_Scale'] = wasmExports['nvgw_Scale'];
    _nvgw_CurrentTransform = Module['_nvgw_CurrentTransform'] = wasmExports['nvgw_CurrentTransform'];
    _nvgw_BeginPath = Module['_nvgw_BeginPath'] = wasmExports['nvgw_BeginPath'];
    _nvgw_ClosePath = Module['_nvgw_ClosePath'] = wasmExports['nvgw_ClosePath'];
    _nvgw_PathWinding = Module['_nvgw_PathWinding'] = wasmExports['nvgw_PathWinding'];
    _nvgw_MoveTo = Module['_nvgw_MoveTo'] = wasmExports['nvgw_MoveTo'];
    _nvgw_LineTo = Module['_nvgw_LineTo'] = wasmExports['nvgw_LineTo'];
    _nvgw_BezierTo = Module['_nvgw_BezierTo'] = wasmExports['nvgw_BezierTo'];
    _nvgw_QuadTo = Module['_nvgw_QuadTo'] = wasmExports['nvgw_QuadTo'];
    _nvgw_ArcTo = Module['_nvgw_ArcTo'] = wasmExports['nvgw_ArcTo'];
    _nvgw_Arc = Module['_nvgw_Arc'] = wasmExports['nvgw_Arc'];
    _nvgw_Rect = Module['_nvgw_Rect'] = wasmExports['nvgw_Rect'];
    _nvgw_RoundedRect = Module['_nvgw_RoundedRect'] = wasmExports['nvgw_RoundedRect'];
    _nvgw_RoundedRectVarying = Module['_nvgw_RoundedRectVarying'] = wasmExports['nvgw_RoundedRectVarying'];
    _nvgw_Circle = Module['_nvgw_Circle'] = wasmExports['nvgw_Circle'];
    _nvgw_Ellipse = Module['_nvgw_Ellipse'] = wasmExports['nvgw_Ellipse'];
    _nvgw_Fill = Module['_nvgw_Fill'] = wasmExports['nvgw_Fill'];
    _nvgw_Stroke = Module['_nvgw_Stroke'] = wasmExports['nvgw_Stroke'];
    _nvgw_CreateFont = Module['_nvgw_CreateFont'] = wasmExports['nvgw_CreateFont'];
    _nvgw_CreateFontAtIndex = Module['_nvgw_CreateFontAtIndex'] = wasmExports['nvgw_CreateFontAtIndex'];
    _nvgw_FindFont = Module['_nvgw_FindFont'] = wasmExports['nvgw_FindFont'];
    _nvgw_FontFace = Module['_nvgw_FontFace'] = wasmExports['nvgw_FontFace'];
    _nvgw_FontSize = Module['_nvgw_FontSize'] = wasmExports['nvgw_FontSize'];
    _nvgw_FontBlur = Module['_nvgw_FontBlur'] = wasmExports['nvgw_FontBlur'];
    _nvgw_TextLetterSpacing = Module['_nvgw_TextLetterSpacing'] = wasmExports['nvgw_TextLetterSpacing'];
    _nvgw_TextLineHeight = Module['_nvgw_TextLineHeight'] = wasmExports['nvgw_TextLineHeight'];
    _nvgw_TextAlign = Module['_nvgw_TextAlign'] = wasmExports['nvgw_TextAlign'];
    _nvgw_Text = Module['_nvgw_Text'] = wasmExports['nvgw_Text'];
    _nvgw_TextBox = Module['_nvgw_TextBox'] = wasmExports['nvgw_TextBox'];
    _nvgw_TextBounds = Module['_nvgw_TextBounds'] = wasmExports['nvgw_TextBounds'];
    _nvgw_TextBoxBounds = Module['_nvgw_TextBoxBounds'] = wasmExports['nvgw_TextBoxBounds'];
    _nvgw_CreateImage = Module['_nvgw_CreateImage'] = wasmExports['nvgw_CreateImage'];
    _nvgw_CreateImageMem = Module['_nvgw_CreateImageMem'] = wasmExports['nvgw_CreateImageMem'];
    _nvgw_CreateImageRGBA = Module['_nvgw_CreateImageRGBA'] = wasmExports['nvgw_CreateImageRGBA'];
    _nvgw_UpdateImage = Module['_nvgw_UpdateImage'] = wasmExports['nvgw_UpdateImage'];
    _nvgw_ImageWidth = Module['_nvgw_ImageWidth'] = wasmExports['nvgw_ImageWidth'];
    _nvgw_ImageHeight = Module['_nvgw_ImageHeight'] = wasmExports['nvgw_ImageHeight'];
    _nvgw_DeleteImage = Module['_nvgw_DeleteImage'] = wasmExports['nvgw_DeleteImage'];
